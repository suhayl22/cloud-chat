$(document).ready(function() {
  ...
  */
  ...
  var messagesRef = new Firebase('https://suhayl.firebaseio.com/');
  ...
  */
  ...
  messagesRef.on('child_added', function (snapshot) {
    ...
    var nameElement = $("<strong class='sh-chat-username'></strong>");
  ...
  */
  ...
  $newMessage.keypress(function (e) {
    ...
    if(messagesRef.push({name:username, text:message})== true)
    {
      audio.play();
    }
